...
def run_experiments(input_path, few_shot, use_dist, balanced, output_path):
    # initiate.
    ...
    for source in all_data:
        for target in all_data:
            ...
            accuracies_all_domains[train_name] = run_gradual_train_groups(
                ...
                balanced=balanced, use_dist=use_dist, few_shot=few_shot,
            )
